...
![2025-01-07-DB%20데이터%20지연쿼리%20개선기-01.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-01.png)

![2025-01-07-DB%20데이터%20지연쿼리%20개선기-02.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-02.png)
...
개발 costs
![2025-01-07-DB%20데이터%20지연쿼리%20개선기-03.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-03.png)

운영 costs
![2025-01-07-DB%20데이터%20지연쿼리%20개선기-04.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-04.png)
...
![2025-01-07-DB%20데이터%20지연쿼리%20개선기-05.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-05.png)

**🤔join 할때 생성된 복합 index에서 connect_key부터 스캔하지 않을까?**

![2025-01-07-DB%20데이터%20지연쿼리%20개선기-06.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-06.png)
...
- **GIN index 생성 방안**
  ...
  ![2025-01-07-DB%20데이터%20지연쿼리%20개선기-07.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-07.png)
...
- **복합 index 추가 생성 방안**
  ...
  ![2025-01-07-DB%20데이터%20지연쿼리%20개선기-08.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-08.png)
  ...
  ![2025-01-07-DB%20데이터%20지연쿼리%20개선기-09.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-09.png)
...
![2025-01-07-DB%20데이터%20지연쿼리%20개선기-10.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-10.png)

운영: 64691 → 6160 costs 감소 (90% 비용 감소)

![2025-01-07-DB%20데이터%20지연쿼리%20개선기-11.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-11.png)

운영 반영 이후, 하루 평균 1만 3천 건 중 2초 이상 지연된 건수는 5건으로 줄었으며, 최대 55초까지 걸리던 응답 시간 문제는 해소되었습니다. 개선된 지연 건수의 응답 시간은 2~3초로 단축되었습니다.

![2025-01-07-DB%20데이터%20지연쿼리%20개선기-12.png](/assets/img/db/2025-01-07-DB%20데이터%20지연쿼리%20개선기-12.png)
