...
- MR 페이지를 브라우저에서 열기
생성 URL 예시:
http://git.duzon.com/api0/noti/merge_requests/new?merge_request%5Bsource_branch%5D=feat/test123&merge_request%5Btarget_branch%5D=servicedev
